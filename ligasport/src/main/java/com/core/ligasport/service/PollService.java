...
import com.core.ligasport.mappers.ModelMapper;
import com.core.ligasport.model.*;
import com.core.ligasport.payload.PagedResponse;
import com.core.ligasport.payload.PollRequest;
import com.core.ligasport.payload.PollResponse;
import com.core.ligasport.payload.VoteRequest;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        logger.info("Question: " + poll.getQuestion());        
        ...
        logger.info("getNumber: " + polls.getNumber());
        logger.info("getSize: " + polls.getSize());
        logger.info("getTotalElements: " + polls.getTotalElements());
        logger.info("getTotalPages: " + polls.getTotalPages());
        logger.info("isLast: " + polls.isLast());
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        if(poll.getExpirationDateTime().isBefore(Instant.now())) {
            throw new BadRequestException("Esta encuesta ha expirado");
        }
        ...
        System.out.println("Vote Saved, Return the updated Poll Response now");
        System.out.println("Retrieve Vote Counts of every choice belonging to the current poll");
        ...
        System.out.println("Retrieve poll creator details");
